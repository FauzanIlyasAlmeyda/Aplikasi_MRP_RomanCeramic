...
public class DasboardAdmin extends javax.swing.JFrame {
    ...
    public DasboardAdmin() {
        ...
        controller.tampilkanSemuaBarang(TabelBarang); // panggil controller untuk isi tabel
    ...
    private void BtnDelActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_BtnDelActionPerformed
        ...
        int konfirmasi = JOptionPane.showConfirmDialog(this, "Apakah yakin ingin menghapus data ini?", "Konfirmasi",
    ...
    private void BtnAddActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_BtnAddActionPerformed
        ...
        // ✅ Generate ID otomatis lewat controller
        String id = controller.generateId();

        Barang b = new Barang(
                id,
                nama,
                "material", // default kategori
                Integer.parseInt(minStok),
                Integer.parseInt(maksStok),
                Integer.parseInt(stok),
                vendor,
                harga);

        boolean success = controller.insertBarang(b);
        if (success) {
            JOptionPane.showMessageDialog(this, "Barang berhasil ditambahkan!");
            controller.tampilkanSemuaBarang(TabelBarang);
        } else {
