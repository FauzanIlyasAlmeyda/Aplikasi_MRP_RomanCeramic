...
public class Produk extends Barang {
    ...
    public Produk(String id, String nama, int stock, int stok_max, int stok_min, String kategori) {
        super(id, nama, stock, stok_max, stok_min, kategori);
    }
    ...
    public int getStok(int stock) {
        return stock;
    }

    public int getStokMax(int stokMax) {
        return stokMax;
    }
}
